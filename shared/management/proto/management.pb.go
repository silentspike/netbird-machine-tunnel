...
func (x *ExposeServiceRequest) Reset() {
	*x = ExposeServiceRequest{}
	mi := &file_shared_management_proto_management_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExposeServiceRequest) Descriptor() ([]byte, []int) {
	return file_shared_management_proto_management_proto_rawDescGZIP(), []int{56}
}
...
func (*ExposeServiceResponse) Descriptor() ([]byte, []int) {
	return file_shared_management_proto_management_proto_rawDescGZIP(), []int{57}
}
...
func (x *RenewExposeRequest) Reset() {
	*x = RenewExposeRequest{}
	mi := &file_shared_management_proto_management_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RenewExposeRequest) Descriptor() ([]byte, []int) {
	return file_shared_management_proto_management_proto_rawDescGZIP(), []int{58}
}
...
func (x *RenewExposeResponse) Reset() {
	*x = RenewExposeResponse{}
	mi := &file_shared_management_proto_management_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RenewExposeResponse) Descriptor() ([]byte, []int) {
	return file_shared_management_proto_management_proto_rawDescGZIP(), []int{59}
}
...
func (x *StopExposeRequest) Reset() {
	*x = StopExposeRequest{}
	mi := &file_shared_management_proto_management_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StopExposeRequest) Descriptor() ([]byte, []int) {
	return file_shared_management_proto_management_proto_rawDescGZIP(), []int{60}
}
...
func (x *StopExposeResponse) Reset() {
	*x = StopExposeResponse{}
	mi := &file_shared_management_proto_management_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StopExposeResponse) Descriptor() ([]byte, []int) {
	return file_shared_management_proto_management_proto_rawDescGZIP(), []int{61}
}
...
func (x *PortInfo_Range) Reset() {
	*x = PortInfo_Range{}
	mi := &file_shared_management_proto_management_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_shared_management_proto_management_proto_rawDesc = "" +
	...
	"\n" +
	"StopExpose\x12\x1c.management.EncryptedMessage\x1a\x1c.management.EncryptedMessage\"\x00\x12`\n" +
...
var file_shared_management_proto_management_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_shared_management_proto_management_proto_goTypes = []any{
	...
	(MachineUpdateType)(0),                 // 4: management.MachineUpdateType
	...
	(*MachineIdentity)(nil),                // 55: management.MachineIdentity
	(*MachineRegisterRequest)(nil),         // 56: management.MachineRegisterRequest
	(*MachineRegisterResponse)(nil),        // 57: management.MachineRegisterResponse
	(*MachineSyncRequest)(nil),             // 58: management.MachineSyncRequest
	(*MachineSyncResponse)(nil),            // 59: management.MachineSyncResponse
	(*MachineRoutesRequest)(nil),           // 60: management.MachineRoutesRequest
	(*MachineRoutesResponse)(nil),          // 61: management.MachineRoutesResponse
	(*MachineStatusRequest)(nil),           // 62: management.MachineStatusRequest
	(*MachineStatusResponse)(nil),          // 63: management.MachineStatusResponse
	(*ExposeServiceRequest)(nil),           // 64: management.ExposeServiceRequest
	(*ExposeServiceResponse)(nil),          // 65: management.ExposeServiceResponse
	(*RenewExposeRequest)(nil),             // 66: management.RenewExposeRequest
	(*RenewExposeResponse)(nil),            // 67: management.RenewExposeResponse
	(*StopExposeRequest)(nil),              // 68: management.StopExposeRequest
	(*StopExposeResponse)(nil),             // 69: management.StopExposeResponse
	nil,                                    // 70: management.SSHAuth.MachineUsersEntry
	(*PortInfo_Range)(nil),                 // 71: management.PortInfo.Range
...
var file_shared_management_proto_management_proto_depIdxs = []int32{
	...
	72, // 19: management.ServerKeyResponse.expiresAt:type_name -> google.protobuf.Timestamp
	...
	73, // 26: management.FlowConfig.interval:type_name -> google.protobuf.Duration
	...
	70, // 39: management.SSHAuth.machine_users:type_name -> management.SSHAuth.MachineUsersEntry
	...
	71, // 53: management.PortInfo.range:type_name -> management.PortInfo.Range
	...
	21, // 60: management.MachineRegisterRequest.meta:type_name -> management.PeerSystemMeta
	31, // 61: management.MachineRegisterResponse.peer_config:type_name -> management.PeerConfig
	25, // 62: management.MachineRegisterResponse.netbird_config:type_name -> management.NetbirdConfig
	55, // 63: management.MachineRegisterResponse.machine_identity:type_name -> management.MachineIdentity
	43, // 64: management.MachineRegisterResponse.allowed_dc_routes:type_name -> management.Route
	44, // 65: management.MachineRegisterResponse.dns_config:type_name -> management.DNSConfig
	21, // 66: management.MachineSyncRequest.meta:type_name -> management.PeerSystemMeta
	33, // 67: management.MachineSyncResponse.network_map:type_name -> management.NetworkMap
	4,  // 68: management.MachineSyncResponse.update_type:type_name -> management.MachineUpdateType
	43, // 69: management.MachineRoutesResponse.routes:type_name -> management.Route
	36, // 70: management.MachineRoutesResponse.router_peers:type_name -> management.RemotePeerConfig
	72, // 71: management.MachineStatusRequest.last_handshake:type_name -> google.protobuf.Timestamp
	72, // 72: management.MachineStatusResponse.server_time:type_name -> google.protobuf.Timestamp
	5,  // 73: management.ExposeServiceRequest.protocol:type_name -> management.ExposeProtocol
	35, // 74: management.SSHAuth.MachineUsersEntry.value:type_name -> management.MachineUserIndexes
	8,  // 75: management.ManagementService.Login:input_type -> management.EncryptedMessage
	8,  // 76: management.ManagementService.Sync:input_type -> management.EncryptedMessage
	24, // 77: management.ManagementService.GetServerKey:input_type -> management.Empty
	24, // 78: management.ManagementService.isHealthy:input_type -> management.Empty
	8,  // 79: management.ManagementService.GetDeviceAuthorizationFlow:input_type -> management.EncryptedMessage
	8,  // 80: management.ManagementService.GetPKCEAuthorizationFlow:input_type -> management.EncryptedMessage
	8,  // 81: management.ManagementService.SyncMeta:input_type -> management.EncryptedMessage
	8,  // 82: management.ManagementService.Logout:input_type -> management.EncryptedMessage
	8,  // 83: management.ManagementService.Job:input_type -> management.EncryptedMessage
	8,  // 84: management.ManagementService.CreateExpose:input_type -> management.EncryptedMessage
	8,  // 85: management.ManagementService.RenewExpose:input_type -> management.EncryptedMessage
	8,  // 86: management.ManagementService.StopExpose:input_type -> management.EncryptedMessage
	56, // 87: management.ManagementService.RegisterMachinePeer:input_type -> management.MachineRegisterRequest
	58, // 88: management.ManagementService.SyncMachinePeer:input_type -> management.MachineSyncRequest
	60, // 89: management.ManagementService.GetMachineRoutes:input_type -> management.MachineRoutesRequest
	62, // 90: management.ManagementService.ReportMachineStatus:input_type -> management.MachineStatusRequest
	8,  // 91: management.ManagementService.Login:output_type -> management.EncryptedMessage
	8,  // 92: management.ManagementService.Sync:output_type -> management.EncryptedMessage
	23, // 93: management.ManagementService.GetServerKey:output_type -> management.ServerKeyResponse
	24, // 94: management.ManagementService.isHealthy:output_type -> management.Empty
	8,  // 95: management.ManagementService.GetDeviceAuthorizationFlow:output_type -> management.EncryptedMessage
	8,  // 96: management.ManagementService.GetPKCEAuthorizationFlow:output_type -> management.EncryptedMessage
	24, // 97: management.ManagementService.SyncMeta:output_type -> management.Empty
	24, // 98: management.ManagementService.Logout:output_type -> management.Empty
	8,  // 99: management.ManagementService.Job:output_type -> management.EncryptedMessage
	8,  // 100: management.ManagementService.CreateExpose:output_type -> management.EncryptedMessage
	8,  // 101: management.ManagementService.RenewExpose:output_type -> management.EncryptedMessage
	8,  // 102: management.ManagementService.StopExpose:output_type -> management.EncryptedMessage
	57, // 103: management.ManagementService.RegisterMachinePeer:output_type -> management.MachineRegisterResponse
	59, // 104: management.ManagementService.SyncMachinePeer:output_type -> management.MachineSyncResponse
	61, // 105: management.ManagementService.GetMachineRoutes:output_type -> management.MachineRoutesResponse
	63, // 106: management.ManagementService.ReportMachineStatus:output_type -> management.MachineStatusResponse
